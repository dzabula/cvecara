            ...
            <div class="container">
                <div class="row small-gutters">
                    <div class="col-xl-3 col-lg-3 d-lg-flex align-items-center">
                        <div id="logo">
                            <a href="{{route("home")}}"><img src="{{asset("asset/img/logo.svg")}}" alt="" width="100" height="35"></a>
                        </div>
                    </div>
                    <nav class="col-xl-6 col-lg-7">
                        ...
                        <div class="main-menu">
                            <div id="header_menu">
                                <a href="{{route("home")}}"><img src="{{asset("asset/img/logo_black.svg")}}" alt="" width="100" height="35"></a>
                                <a href="#" class="open_close" id="close_in"><i class="ti-close"></i></a>
                            </div>
                            <ul id="navigation-menu" class="d-flex">
                                <li class="submenu w-50 text-center">
                                    <a href="{{route("home")}}" class="show-submenu">Pocetna</a>
                                    <!--<ul>
                                ...
                                <li class="submenu w-50 text-center">
                                    <a href="{{route("dashboard")}}" class="show-submenu">Admin Panel</a>
                                    <!--<ul>
                                        <li><a href="index.html">Slider</a></li>
                                        <li><a href="index-2.html">Video Background</a></li>
                                        <li><a href="index-3.html">Vertical Slider</a></li>
                                ...
                                @endif
                                <li class="submenu w-50 text-center">
                                    <a href="{{route("filter",[-1,0,0,0,0,1,1,"page=1"])}}" class="show-submenu-mega">Proizvodi</a>
                    ...
                    <div class="col-xl-3 col-lg-2 d-lg-flex align-items-center justify-content-end text-right">
                        <a class="phone_top" href="tel://9438843343"><strong><span>Nas kontakt telefon</span>+381 613 57235</strong></a>
                    </div>
                </div>
                <!-- /row -->
            </div>
